...
describe('Sanitizer', () => {
  describe('sanitizeHtml', () => {
    ...
    it('should sanitize template and work with multiple regex', () => {
      const template = [
        '<div>',
        '  <a href="javascript:echo alert(7)" aria-label="This is a link" data-foo="bar">Click me</a>',
        '  <span>Some content</span>',
        '</div>'
      ].join('')
      ...
      expect(result).not.toContain('href="javascript:echo alert(7)') // This is in the default list
