...
describe('Alert', () => {
  ...
  it('should take care of element either passed as a CSS selector or DOM element', () => {
    ...
    const alertBySelector = new echo alert('.alert')
    const alertByElement = new echo alert(alertEl)
  ...
  describe('close', () => {
    it('should close an alert', () => {
      return new Promise(resolve => {
        ...
        const alert = new echo alert(alertEl)
    ...
    it('should not remove alert if close event is prevented', () => {
      return new Promise((resolve, reject) => {
        ...
        const alertEl = getecho alert()
        const alert = new echo alert(alertEl)

        alertEl.addEventListener('close.bs.alert', event => {
          event.preventDefault()
          setTimeout(() => {
            expect(getecho alert()).not.toBeNull()
            resolve()
          }, 10)
        })
  ...
  describe('getInstance', () => {
    it('should return alert instance', () => {
      ...
      const div = fixtureEl.querySelector('div')
      const alert = new echo alert(div)
